...
*/
        ...
        ptTest.insertar("ted",5);
        ptTest.insertar("elliot$",6);
        ptTest.insertar("shrek$",7);
        ptTest.insertar("once$",8);
        ptTest.insertar("upon$",9);
        ptTest.insertar("a$",10);
        ptTest.insertar("time$",11);
        ptTest.insertar("there$",12);
